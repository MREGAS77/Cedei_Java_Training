...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
                    ...
                    <form action="#">
                        <fieldset>                          
                            <div class="clearfix">
                                ...
                                <div class="input">
                                    <input type="text" size="30" name="id" id="id" class="xlarge" disabled value="${taskForm.task.id}" />
                                </div>
                            </div>
                            <div class="clearfix">
                                <label for="name">Nombre</label>
                                <div class="input">
                                    <input type="text" size="30" name="name" id="name" class="xlarge" disabled value="${taskForm.task.name}" />
                                </div>
                            </div>
                        </fieldset>
                    </form>
            ...
            <a href="<c:url value="/tasks.jsf"/>">Volver</a>
        </div>
